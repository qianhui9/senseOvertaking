...
@click.option('--episodes', default=1800, help='Number of epsiodes.', type=int)
...
def runMARL(seed, episodes, batch_size, gamma, inverting_gradients, initial_memory_threshold, replay_memory_size,
    ...
    for i_eps in range(episodes):
        ...
        df.to_csv('opencda/scenario_testing/result/normal/reward.csv', index=False, mode='a', header=False)
