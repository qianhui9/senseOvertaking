...
def plotResult():
    # 加载保存的CSV数据
    returns = np.loadtxt("result/normal/reward.csv", delimiter=',')
...
def plotResultSmooth():
    # 加载保存的CSV数据
    returns = np.loadtxt("result/normal/reward.csv", delimiter=',')
    returnsSmooth = scipy.signal.savgol_filter(returns, 20, 1)
    # 绘制折线图
...
def plotSpeedSec():
    # 加载两个CSV文件的数据
    data_file1 = np.loadtxt("result/normal/agent1_speedControl.csv", delimiter=',')
    data_file2 = np.loadtxt("result/normal/agent2_speedControl.csv", delimiter=',')
    data_file3 = np.loadtxt("result/normal/agent3_speedControl.csv", delimiter=',')
    ...
    # 绘制折线图
    plt.plot(average_values_file1, marker='o', label='agent1 speed', color='blue')
    plt.plot(average_values_file2, marker='o', label='agent2 speed', color='red')
    plt.plot(average_values_file3, marker='o', label='agent3 speed', color='yellow')
...
def plotTTCSec():
    # 加载两个CSV文件的数据
    data_file1 = np.loadtxt("result/normal/agent1_ttc.csv", delimiter=',')
    data_file2 = np.loadtxt("result/normal/agent2_ttc.csv", delimiter=',')
    data_file3 = np.loadtxt("result/normal/agent3_ttc.csv", delimiter=',')
    ...
    # 绘制折线图
    plt.plot(average_values_file1, marker='o', label='agent1 ttc', color='blue')
    plt.plot(average_values_file2, marker='o', label='agent2 ttc', color='red')
    plt.plot(average_values_file3, marker='o', label='agent3 ttc', color='yellow')
